...
import MunicipalBillScreen from './MunicipalBillScreen';

const data = {
    heading:'Municipal Bill',
    prevPath:'MunicipalFileMain',
  }

export default function MunicipalBillMain() {
  ...
  return (
    <View  style= {style.mainbg}>
        ...
        <View style={{width:'83%', alignSelf:'center', marginTop:moderateVerticalScale(20), rowGap:15}}>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                <Text style={{fontWeight:'bold'}}>Policy from Date</Text>
                <Text style={{fontWeight:'bold', color:'black'}}>12 Feb 2023</Text>
            </View>

            <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                <Text style={{fontWeight:'bold'}}>Policy Date</Text>
                <Text style={{fontWeight:'bold', color:'black'}}>12 Feb 2023</Text>
            </View>

            <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                <Text style={{fontWeight:'bold'}}>Product Name</Text>
                <Text style={{fontWeight:'bold', color:'black'}}>XYZ</Text>
            </View>

        </View>
        <View style={style.recharge}>
        <Text keyboardType='numeric' style={{fontSize:24, fontWeight:'bold', color:'#0378FF', marginTop:moderateScale(10)}}>₹ 1,000</Text>
        <Text style={{fontSize:15, color:'black'}}>Bill due date : 20 Feb 2024</Text>
        </View>
        <Pressable  onPress={() => {
