...
//import WaterBillHeader from './WaterBillHeader';
import { useNavigation } from '@react-navigation/native';
import Header from '../../commonComponent/Header';
import InsuranceBillScreen from './InsuranceBillScreen';

const data = {
  heading: 'Insurance Bill',
  prevPath: 'InsuranceMain',
};

export default function InsuranceBillMain() {
